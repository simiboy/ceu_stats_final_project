...
After the analysis, it can be summarised that 'a Fox News Effect' is not clearly visible and verifiable. Thus, the first hypothesis of the paper must also be refuted, as there is no clear evidence that Fox News together with socioeconomic background affects the behaviour of the electorate in 2000. 

We could also argue that it can be that in those states that were already more Republican those states are where Fox News became available for everybody. This would show that vote for the Republican party is not the consequence of Fox News but it might strengthened the parties position. \newpage
