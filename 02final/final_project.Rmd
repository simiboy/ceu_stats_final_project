...
```{r avgVoteShare, echo=FALSE, warning=FALSE, fig.cap="Average two-party vote share for the Republicans in 2000 in the different states."}
...
```{r independentVariables, echo=FALSE, fig.cap="Independent variables in the study."}
...
```{r change, echo=FALSE, fig.show="hold", out.width="50%", fig.cap="Change in Republican vote share between the three observed elections."}
