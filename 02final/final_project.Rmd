...
This paper uses data that was collected in 1992, 1996 and 2000 [@DellaVigna2007]. The data set [@DellaVigna2007] contains town-based data on two-party vote share for the Republicans, socio-cultural details and share of Fox news subscribers.
...
high_hisp_pop.t_w_foxnews<- subset(towns_w_foxnews, subset = hisp1990 >= 0.4)

high_hisp_pop.t_no_foxnews<- subset(towns_no_foxnews, subset = hisp1990 >= 0.4)
...
####SATE town with low proportion of a hispanic population
...
####SATE town with no proportion of a hispanic  population
...
plot(years,sate_high_hisp_pop_t_w_fn, pch = 16, col = "coral3",
xlim = c(1992, 2000), ylim = c(-0.15, 0.2), xlab = "Days of presidential election",
ylab = "Estimated sample average fox news effect",
main = "Trends in Fox News Effects among the hispanic population")

points(years, sate_low_hisp_pop_t_w_fn,pch=16, col = "blue4")
points(years, sate_no_hisp_pop_t_w_fn,pch = 16, col = "cyan")

lines(years,sate_high_hisp_pop_t_w_fn, type="c", col="coral3")
lines(years, sate_low_hisp_pop_t_w_fn,type="c", col = "blue4")
lines(years, sate_no_hisp_pop_t_w_fn,type="c", col = "cyan")


text(1998,-0.1,"High Hispanic Population", col="coral3")
text(1993,0.12,"Low Hispanic Population", col="blue4")
text(1993, 0.04, "No Hispanic Population", col="cyan")
```
Interestingly, the data set does not include the combination of cities that have a majority of Fox News and a high Hispanic population, but cities with a high proportion of hispanic population and no fox news are close to 60.This could suggest that Fox New was more quickly and readily implemented in states that have a high proportion of conservative voters in the first place (discussed in more detail in the discussion part). As in the evaluation of the SATE among black people, the characterization of cities with no/middle and high Hispanic populations was not done using the quantiles, as the difference between the third quantile and the maximum would have been too great. Therefore, in relation to the maximum, the value 0.4 was set as the limit for a city with a high Hispanic population. However, the trends in Fox News Effects among the hispanic population are decreasing in towns with a low or a medium high hispanic population.
