...
```{r diffInDiff_income, fig.cap="Differences in Vote Share in High and Low Income Towns", echo=FALSE, warning=FALSE}
...
```{r diffInDiff_income, fig.cap="Differences in Vote Share in Average Higher and Lower Educated Towns", echo=FALSE, warning=FALSE}
