...
Our hypotheses stating, that it might be possible that socioeconomic backgrounds like education and race of people influence a potential 'Fox News Effect' differently . It could be also possible that voters with different incomes get effected differently by the input of Fox News.
...
stargazer::stargazer(fox_news_effect,
## Title of the table
title = "Effect of fox news and socio-economic factors on voting",
...
covariate.labels = c("Intercept", "Share of Fox News subscribers", "Income", "Rate of hispanic or black people", "Education level"),
dep.var.labels = c("Two party vote share for Republicans in 2000"),
header = FALSE,
type = "latex")
...
Figure \ref{fig:foxFX} analyses the Foxnews effect both on the Republican vote share and on the change of Republican vote share between elections. The graphs show that as the share of fox news subscribers increase, both the predicted Republican vote and the positive change of Republican vote share decreases, indicating a negative Foxnews effect.
...
predIncome0 <- colMeans(predict (fox_news_effect, newdata = data.frame(subrf2000 = data$subrf2000, income1990 = 0, hisp1990 = data$hisp1990, black1990 = data$black1990, college1990 = data$college1990), interval = "confidence", level = 0.95), na.rm=T)
predIncome1 <- colMeans(predict (fox_news_effect, newdata = data.frame(subrf2000 = data$subrf2000, income1990 = 1, hisp1990 = data$hisp1990, black1990 = data$black1990, college1990 = data$college1990), interval = "confidence", level = 0.95), na.rm=T)

printPlot(predIncome0, predIncome1, "Level of Income", "Predicted Republican vote share", "#0000aa")

predEdu0 <- colMeans(predict (fox_news_effect, newdata = data.frame(subrf2000 = data$subrf2000, income1990 = data$income1990, hisp1990 = data$hisp1990, black1990 = data$black1990, college1990 = 0), interval = "confidence", level = 0.95), na.rm=T)
predEdu1 <- colMeans(predict (fox_news_effect, newdata = data.frame(subrf2000 = data$subrf2000, income1990 = data$income1990, hisp1990 = data$hisp1990, black1990 = data$black1990, college1990 = 1), interval = "confidence", level = 0.95), na.rm=T)
...
predBlack0 <- colMeans(predict (fox_news_effect, newdata = data.frame(subrf2000 = data$subrf2000, income1990 = data$income1990, hisp1990 = data$hisp1990, black1990 = 0, college1990 = data$college1990), interval = "confidence", level = 0.95), na.rm=T)
predBlack1 <- colMeans(predict (fox_news_effect, newdata = data.frame(subrf2000 = data$subrf2000, income1990 = data$income1990, hisp1990 = data$hisp1990, black1990 = 1, college1990 = data$college1990), interval = "confidence", level = 0.95), na.rm=T)

printPlot(predBlack0, predBlack1, "Share of black population", "Predicted Republican vote share", "#882222")

predHisp0 <- colMeans(predict (fox_news_effect, newdata = data.frame(subrf2000 = data$subrf2000, income1990 = data$income1990, hisp1990 = 0, black1990 = data$black1990, college1990 = data$college1990), interval = "confidence", level = 0.95), na.rm=T)
predHisp1 <- colMeans(predict (fox_news_effect, newdata = data.frame(subrf2000 = data$subrf2000, income1990 = data$income1990, hisp1990 = 1, black1990 = data$black1990, college1990 = data$college1990), interval = "confidence", level = 0.95), na.rm=T)
