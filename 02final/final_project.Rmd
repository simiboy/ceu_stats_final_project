...
means_no_black_pop.t_some_foxnews<-colMeans(no_black_pop.t_some_foxnews[c('gopvoteshare1992','gopvoteshare1996','gopvoteshare2000')], na.rm = T)


sate_no_black_pop_t_w_fn<- means_no_black_pop.t_no_foxnews - means_no_black_pop.t_w_foxnews
sate_no_black_pop_t_w_fn

sate_no_black_pop_t_some_fn<- means_no_black_pop.t_no_foxnews- means_no_black_pop.t_some_foxnews
sate_no_black_pop_t_some_fn


plot(years,sate_high_black_pop_t_w_fn, pch = 16, col = "aquamarine3",
xlim = c(1992, 2000), ylim = c(-0.3, 0.15), xlab = "Days of presidential election",
ylab = "Estimated sample average fox news effect",
main = "Trends in Fox News Effects among black population")

points(years, sate_high_black_pop_t_some_fn, pch= 16, col="aquamarine3")
points(years, sate_low_black_pop_t_w_fn,pch=16, col = "darkseagreen4")
points(years, sate_low_black_pop_t_some_fn,pch = 16, col = "darkseagreen4")
points(years, sate_no_black_pop_t_w_fn,pch = 16, col = "mediumorchid1")
points(years, sate_no_black_pop_t_some_fn,pch = 16, col = "mediumorchid1")

lines(years,sate_high_black_pop_t_w_fn, type="c", col="aquamarine3")
lines(years,sate_high_black_pop_t_some_fn, type="c", col="aquamarine3")
lines(years, sate_low_black_pop_t_w_fn,type="c", col = "darkseagreen4")
lines(years, sate_low_black_pop_t_some_fn,type="c", col = "darkseagreen4")
lines(years, sate_no_black_pop_t_w_fn,type="c", col = "mediumorchid1")
lines(years, sate_no_black_pop_t_some_fn,type="c", col = "mediumorchid1")
...
high_edu.t_some_foxnews<- subset(towns_some_foxnews, subset = college1990 >= 0.19255)
...
sate_high_edu.t_some_foxnews<- means_high_income.t_no_foxnews -means_high_income.t_some_foxnews
sate_high_edu.t_some_foxnews
...
means_medium_edu.t_some_foxnews<-colMeans(medium_edu.t_some_foxnews[c('gopvoteshare1992','gopvoteshare1996','gopvoteshare2000')], na.rm = T)

sate_medium_edu.t_w_foxnews<- means_medium_edu.t_no_foxnews- means_medium_edu.t_w_foxnews
sate_medium_edu.t_w_foxnews

sate_medium_edu.t_some_foxnews<- means_medium_edu.t_no_foxnews- means_medium_edu.t_some_foxnews
sate_medium_edu.t_some_foxnews
...
low_edu.t_some_foxnews<- subset(towns_some_foxnews, subset = college1990 <= 0.08145)
...
sate_low_edu.t_w_foxnews<-means_low_edu.t_no_foxnews- means_low_edu.t_w_foxnews
sate_high_edu.t_w_foxnews

sate_low_edu.t_some_foxnews<-means_low_edu.t_no_foxnews- means_low_edu.t_some_foxnews
sate_high_edu.t_some_foxnews
...
points(years, sate_medium_edu.t_some_foxnews,pch = 16, col = "darksalmon")
points(years, sate_medium_edu.t_w_foxnews,pch = 16, col = "deeppink4")
points(years, sate_medium_edu.t_some_foxnews,pch = 16, col = "deeppink4")
points(years, sate_low_edu.t_w_foxnews,pch = 16, col = "grey80")
points(years, sate_low_edu.t_some_foxnews,pch = 16, col = "grey80")

lines(years,sate_high_edu.t_w_foxnews, type="c", col="darksalmon")
lines(years,sate_high_edu.t_some_foxnews, type="c", col="darksalmon")
lines(years, sate_medium_edu.t_w_foxnews,type="c", col = "deeppink4")
lines(years, sate_medium_edu.t_some_foxnews,type="c", col = "deeppink4")
...
#creating a new variable explaining the combined share of population who is black or hispanic
