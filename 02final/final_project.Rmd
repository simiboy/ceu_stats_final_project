...
and Gaudet's [@Lazarsfeld1968] research analysis whose results show
...
behavior. Kriesi, Grande, and Lachat [@Kriesi2008] also argue people's voting
...
distinction between the winners and losers of globalization [@Kriesi2008]. Losers of globalization feel that their social status is
...
determines their voting behavior [@Kriesi2008]. In contrast, the
winners of globalization benefit from open borders, they have more
opportunities and therefore they vote differently [@Kriesi2008]
...
Zwiebel's [@DeMarzo2003] research analysis that persuasion bias (like
...
Sociological model of voting Kriesi's [@Kriesi2008]: People's voting behavior
is just shaped by long-term factors (socialization).

**HP2:** Just socioeconomic background effects the behavior of the
electorate.

Rational expectation theories [@Bray1987] :Voters often filter
...
Behavioral Theories [@DeMarzo2003]: assert that
